...
func (app *NodelabsApp) ExportAppStateAndValidators(forZeroHeight bool, jailAllowedAddrs []string, modulesToExport []string) (servertypes.ExportedApp, error) {
...
func (app *NodelabsApp) prepForZeroHeightGenesis(ctx sdk.Context, jailAllowedAddrs []string) error {
