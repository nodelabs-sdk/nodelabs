...
import (
	...
	"github.com/nodelabs-sdk/nodelabs/app"
...
func NewRootCmd() *cobra.Command {
	...
	rootCmd := &cobra.Command{
		...
		Short: "Nodelabs Cosmos EVM Chain",
...
func initRootCmd(rootCmd *cobra.Command, nodelabsApp *app.NodelabsApp) {
	cfg := sdk.GetConfig()
	cfg.Seal()
	...
	rootCmd.AddCommand(
		...
		genutilcli.Commands(nodelabsApp.TxConfig(), nodelabsApp.BasicModuleManager, defaultNodeHome),
...
func appExport(
	...
	var nodelabsApp *app.NodelabsApp
